...
#### IT 부서 전달용 SHA256 (Windows Defender 예외 처리)

캡처 + 에디터는 **단일 EXE 단일 프로세스** 구조 (`ui/main_window.py` 의 `_open_editor_with_frames`
가 같은 프로세스 내에서 에디터 윈도우를 띄움). 따라서 아래 두 해시로 **설치 시점 + 실행 시점**
양쪽이 모두 커버됨 — 캡처/에디터를 위한 별도 해시는 필요 없음.

| 파일 | 검사 시점 | SHA256 |
|------|----------|--------|
| `XGif_Setup_2.2.0.exe` | 설치 (Inno Setup 인스톨러) | `c0032c453f2117ef165b60e55b054cb800376671c12e4569ae55c6e1e2a0423a` |
| `XGif.exe` | 실행 (캡처 + 에디터 공통, PyInstaller onefile) | `3b78e0d1a34cd2b83386e6412942814694545d6f02a24e513150f48e9599bb0f` |
